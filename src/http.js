...
var privateCall = function privateCall(_ref4) {
  ...
  return function (path) {
    ...
    return (data && data.useServerTime ? publicCall('/v1/time').then(function (r) {
      ...
      return sendResult(fetch('' + BASE + (path.includes('/hz-cryptio') ? '' : '/api') + path + (noData ? '' : makeQueryString(newData)), {
        method: method,
...
exports.default = function (opts) {
  ...
  return {
    ...
    withdraw: function withdraw(payload) {
      return pCall('/sapi/v1/capital/withdraw/apply', payload, 'POST');
    },
    withdrawHistory: function withdrawHistory(payload) {
      return pCall(' /sapi/v1/capital/withdraw/history', payload);
    },
    depositHistory: function depositHistory(payload) {
      return pCall('/sapi/v1/capital/deposit/hisrec', payload);
    },
    depositAddress: function depositAddress(payload) {
      return pCall('/sapi/v1/capital/deposit/address', payload);
    },
